...
%>
<div class="container">
<form action="updateSalaryAction.jsp" method="post">
<hr>
<h2>ID</h2>
<input type="number" value="<%=rs.getString(1)%>" name="id">
<hr>
<h2>Name</h2>
...
<hr>
<h2>Phone Number</h2>
<input type="number" value="<%=rs.getString(4)%>" name="phonenumber">
<hr>
<h2>Salary</h2>
<input type="number" value="<%=rs.getString(6)%>" name="salary">
<br>
<br>
<br>
